...
<div class="fourteen wide column">
	...
	<table class="ui black table">
		...
		<tbody>
			...
			<tr>
				...
				<td><center><img src={{ "/images/templates/" . $config->templatePreview }} class="ui small image"></center></td>
				<td><center>{{ $config->schedulerTitle }}</center></td>
				<td>
					<center>
						<a class="ui vertical animated button" href={{ "/admin/generic/configs/" . $config->id . "/items" }}><div class="hidden content">Items</div><div class="visible content"><i class="cubes icon"></i></div></a>
	...
	<form class="ui form" method="POST" action="/admin/generic/configs/add" enctype="multipart/form-data">
